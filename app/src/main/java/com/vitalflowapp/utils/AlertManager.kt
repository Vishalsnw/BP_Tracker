...
import com.vitalflowapp.MainActivity
import com.vitalflowapp.R
import com.vitalflowapp.data.model.AlertSettings
import com.vitalflowapp.data.model.AlertType
...
class AlertManager @Inject constructor(
    ...
    fun sendWeeklySummaryNotification(summary: WeeklySummary) {
        ...
        val trendText = when (summary.trendVsPrevWeek) {
            com.vitalflowapp.data.model.TrendDirection.IMPROVING -> "Your BP has improved compared to last week!"
            com.vitalflowapp.data.model.TrendDirection.WORSENING -> "Your BP has increased compared to last week."
            com.vitalflowapp.data.model.TrendDirection.STABLE -> "Your BP has remained stable."
        }
